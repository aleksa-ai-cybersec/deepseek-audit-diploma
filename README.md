...
Инструмент для автоматизированного аудита безопасности языковых моделей (DeepSeek-V3-0324). Реализован в рамках дипломной работы по теме "Разработка методики аудита информационной безопасности систем, использующих технологии искусственного интеллекта".
