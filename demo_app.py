...
translations = {
    "ru": {
        ...
        "risk_categories": [
            ...
            "Кража модели и IP",
            "DoS-атаки и отказы в обслуживании",
            "Подмена и компрометация модели",
    ...
    "en": {
        ...
        "risk_categories": [
            ...
            "Jailbreak Attacks (bypass restrictions)",
            "Confidential Data Leakage",
            "Malicious Code Generation",
            "Model Theft and IP",
            "DoS Attacks and Service Denial",
            "Model Replacement and Compromise",
            "Data and Label Poisoning",
            "Source and Code Compromise",
            "Testing Manipulation",
        ...
        "risk_probs": ["Low", "Low", "Medium", "Low", "High", "Medium", "High", "High", "High", "High", "High", "Medium", "High"],
        "risk_impacts": ["Low", "Low", "High", "Low", "High", "High", "High", "Medium", "High", "High", "Medium", "Low", "High"],
        "risk_scores": [1, 1, 6, 1, 9, 6, 9, 6, 9, 9, 6, 2, 9],
        "risk_levels": ["low", "low", "high", "low", "critical", "high", "critical", "high", "critical", "critical", "high", "low", "critical"],
    ...
    "zh": {
        ...
        "risk_probs": ["低", "低", "中", "低", "高", "中", "高", "高", "高", "高", "高", "中", "高"],
        "risk_impacts": ["低", "低", "高", "低", "高", "高", "高", "中", "高", "高", "中", "低", "高"],
        "risk_scores": [1, 1, 6, 1, 9, 6, 9, 6, 9, 9, 6, 2, 9],
        "risk_levels": ["low", "low", "high", "low", "critical", "high", "critical", "high", "critical", "critical", "high", "low", "critical"],
        "about_title": "👩‍🎓 关于作者",
